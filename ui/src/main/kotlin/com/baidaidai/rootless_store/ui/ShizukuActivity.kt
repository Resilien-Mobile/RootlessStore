package com.baidaidai.rootless_store.ui
...
class ShizukuActivity: ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContent {
            val shizukuAdbScreenViewModel: RootlessStoreShizukuAdbScreenViewModel =
                hiltViewModel<RootlessStoreShizukuAdbScreenViewModel>()
